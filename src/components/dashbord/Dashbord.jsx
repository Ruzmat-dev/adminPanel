...
function Dashbord() {
    ...
    const changeMenu = () => {
        if(style == "navbar-nav bg-gradient-primary sidebar sidebar-dark accordion") {
            setStyle("navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggledMenu")
        }else {
            setStyle("navbar-nav bg-gradient-primary sidebar sidebar-dark accordion")
        }
    }
          ...
          <ul className={style} id="accordionSidebar">
            ...
            <div className="text-center d-none d-md-inline">
              <button
                ...
                id="sidebarToggle" onClick={changeStyle}
              ></button>
            </div>
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            ...
            <div id="content">
              ...
              <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <button
                  id="sidebarToggleTop"
                  className="btn btn-link d-md-none rounded-circle mr-3" onClick={changeMenu}
                >
                            ...
                            <div className="row no-gutters align-items-center">
                              ...
                              <div className="col">
                                <div className="progress progress-sm mr-2">
                                  <div
                                    className="progress-bar bg-info earnings"
                                    role="progressbar"
                                  ></div>
                                </div>
                              </div>
                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-danger projectCard"
                            role="progressbar"
                          ></div>
                        </div>
                        <h4 className="small font-weight-bold">
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-warning projectCardProgress"
                            role="progressbar"
                          ></div>
                        </div>
                        <h4 className="small font-weight-bold">
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar projectCardProgressbar"
                            role="progressbar"
                          ></div>
                        </div>
                        <h4 className="small font-weight-bold">
                        ...
                        <div className="progress mb-4">
                          <div
                            className="progress-bar bg-info progressInfo"
                            role="progressbar"
                          ></div>
                        </div>
                        <h4 className="small font-weight-bold">
                        ...
                        <div className="progress">
                          <div
                            className="progress-bar bg-success progressSuccess"
                            role="progressbar"
                          ></div>
                        </div>
                      </div>
                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        <div className="text-center">
                          <img
                            className="img-fluid px-3 px-sm-4 mt-3 mb-4 Illustrations"
